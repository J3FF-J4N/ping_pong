...
const IP_ECHO: (Ipv4Addr, u16) = (Ipv4Addr::LOCALHOST, 34254);//"127.0.0.1:34254"; //"192.168.1.70:34254";
const IP_MASTER : (Ipv4Addr, u16) = (Ipv4Addr::LOCALHOST, 0); //"192.168.1.69:34254";
...
pub fn handle_connection(side: Side) -> Result<(), Box<dyn Error>> {
    if let Side::Server(_) = side {
        ...
        println!("Echo listening on {:?}", IP_MASTER);
        ...
        println!("Master bound to {}", socket.local_addr()?);
